...
#inputp=SceneLogicBase.sendauthcodeinput
#print(inputp)
Capp.cuserSendauthcode(iteration,mobilephone,cappver,envType,capptoken,deviceType,userId,deviceCode,appType,inputp=SceneLogicBase.sendauthcodeinput,outputp=SceneLogicBase.sendauthcodeoutput,returnvalue=None)
Capp.cuserRegister(iteration,'13401000655',cappver,envType,capptoken,deviceType,userId,deviceCode,appType,verifyCode,password,password,"1","jinghua",agree,returnvalue=None,inputp=SceneLogicBase.cuserregisterinput,outputp=SceneLogicBase.cuserregisteroutput)
Capp.cuserLogin(iteration,mobilephone,cappver,envType,capptoken,deviceType,userId,deviceCode,appType,password,returnvalue=None,inputp=SceneLogicBase.cuserlogininput,outputp=SceneLogicBase.cuserloginoutput)
Bapp.systemSendauthcode(iteration,mobilephone,appVer,envType,bapptoken,deviceType,userId,deviceCode,appType,returnvalue=None,inputp=SceneLogicBase.syssendauthcodeinput,outputp=SceneLogicBase.syssendauthcodeoutput)
